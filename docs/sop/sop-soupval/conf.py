...
apply_base_config(
    globals(),
    project_name="SOP-Software of Unknown Provenance Validation Procedure",
    autosectionlabel_prefix="qms_sop_soupval",
)

apply_cross_project_nav(globals(), "sop-soupval")
