...
.. code-block:: bash
   ...
   git add docs/project_control/records/process_training_confirmation.rst

   git commit -s -S -m "docs(qms): Confirm SOP training for <name>"
...
.. list-table::
   ...
   * - GPG signature public fingerprint
     - | pub   ed25519/94D23A6534BE3697 2025-09-06 [SC]
       |       5012128B8FE98CF84B3CD0A394D23A6534BE3697
       | uid   [ultimate] Volker Kempert (general purpose) <volker.kempert@almedso.de>
       | sub   cv25519/580AC9FC2C3B9A0D 2025-09-06 [E]
