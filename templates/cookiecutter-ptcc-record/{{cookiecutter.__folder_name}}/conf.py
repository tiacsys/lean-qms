...
apply_base_config(
    globals(),
    project_name="PTCC - {{ cookiecutter.__full_name }}",
    autosectionlabel_prefix="{{ cookiecutter.__autosectionlabel_prefix }}",
)

apply_cross_project_nav(globals(), "{{ cookiecutter.__folder_name }}")
...
latex_documents = [
    (
        "index",
        "{{ cookiecutter.__folder_name }}.tex",
